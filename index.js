...
typewriter
  .pauseFor(1000)
  .typeString('I am a phone repairman and content creator from the United Kingdom.') //Add your own tagline
  .pauseFor(3000)
  .start()
...
btn3.onclick = function() { 
  window.open("https://discord.gg/ydavdwtYjy", "_blank") //TODO add your link
}
...
btn6.onclick = function() { 
  window.open("https://www.youtube.com/@Lu5w", "_blank") //TODO add your link
}
